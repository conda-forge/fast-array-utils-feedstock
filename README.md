About fast-array-utils-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fast-array-utils-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fast-array-utils-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fast-array-utils
# for installing globally
pixi global install fast-array-utils
```
...
It is possible to list all of the versions of `fast-array-utils` available on your platform:
...
```
pixi search fast-array-utils --channel conda-forge
```
